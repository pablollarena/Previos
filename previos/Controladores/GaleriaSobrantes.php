...
include_once ("../Modelos/ImagenesSobrantes.php");
session_start();
$oMenu = new Menu();
$oPers = new Persona();
$oImg = new ImagenesSobrantes();
$arrImg = null;
$sErr ="";
$sNom = "";
$nGrp = 0;
...
if(isset($_SESSION['sUser']) && !empty($_SESSION['sUser'])){
    ...
    $oImg->setSobrante(new SobrantesPartida());
    $oImg->getSobrante()->setReferencia60(new Sir60Referencias());
    $oImg->getSobrante()->getReferencia60()->setReferencia($sRef1);
    $oImg->getSobrante()->setNumItem($nItem);
    $arrImg = $oImg->buscarImagenesSobrantes();
                                    ...
                                    foreach ($arrImg as $vImg){
                                        ...
                                        <div class="col-md-6">
                                            <div class="image view view-first">
                                                <img data-toggle="magnify" src="<?php echo $vImg->getRuta()."/".$vImg->getNombreArchivo(); ?>"style="width: 100%; display: block;" class="img-responsive img-rounded center-block" alt="image">
                                            </div>
                                            <br/><br/>
                                        </div> <!--/.cool-md-12-->
                                        <?php
