...
<head>
    ...
    <script>
        $(function(){
            $("#btnGenerarSobrantes").click(function () {
                var url = "../Controladores/listaSobrantes.php";
                $.ajax({
                    type: "POST",
                    url : url,
                    data : $("#frmSobrante").serialize(),
                    success: function(data)
                    {
                        $("#infoSobrante").html(data);
                    }
                });
                return false;
            });
            ...
            <div class="">
                <div class="row">
                    <div class="col-md-12 col-sm-6 col-xs-12">
                        <div class="x_panel">
                            <div class="x_title">
                                <h2><i class="fa fa-bars"></i> Mercancia no Asignada a Factura</h2>
                            ...
                            <div class="x_content">
                                ...
                                <form id="frmSobrante">
                                    <input type="hidden" name="sRef" value="<?php echo $sRef?>">
                                    <div class="form-group">
                                        <div class="col-sm-6 col-xs-12">
                                            <label class="col-sm-5 col-xs-12 control-label">Cantidad Sobrantes</label>
                                            <div class="input-group">
                                                <input type="number" min="1" class="form-control" required name="txtSobrante">
                                                <span class="input-group-btn">
                                                    <input type="submit" id="btnGenerarSobrantes" class="btn btn-primary" value="Generar" />
                                                </span>
                                            </div>
                                        </div>
