...
if(isset($_SESSION['sUser']) && !empty($_SESSION['sUser'])){
    ...
    if (isset($_POST['txtRef']) && !empty($_POST['txtRef']) && isset($_POST['txtFac']) && !empty($_POST['txtFac'])){
        ...
        $_SESSION['sReporte'] = $oReporte;
        $arrItem = $oReporte->buscarItemsPorFactura();
        $nFactura = $_POST['txtFac'];
    }else if (isset($_SESSION['sReporte']) && !empty($_SESSION['sReporte'])){
        $oRep = $_SESSION['sReporte'];
        $nRef = $oRep->getSir60()->getReferencia();
        $nFactura = $oRep->getSir52()->getNumero();
        $arrItem = $oRep->buscarItemsPorFactura();
        $nMsj = 1;
        $nFactura = $oRep->getSir52()->getNumero();
    }
        ...
        <div class="right_col" role="main">
            <div class="">
                <div class="col-md-12 col-sm-6 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>ITEMS DE LA FACTURA <?php echo $nFactura;?></h2>
                                        ...
                                        <div class="accordion" id="accordion" role="tablist" aria-multiselectable="false">
                                            ...
                                            if($arrItem != null) {
                                                foreach ($arrItem as $vRow) {
                                                    $dHab = $oReporte->validarItem($nRef,$vRow->getSir52()->getItem(),$nFactura);
                                                    ?>
                                                    <div class="x_content">
                                                        <form id="frmPrevio<?php echo $nCont; ?>">
                                                            <input type="hidden" name="txtRef1"
                                                                   value="<?php echo $nRef; ?>">
                                                            <input type="hidden" name="txtFac1"
                                                                   value="<?php echo $nFactura; ?>">
                                                            <input type="hidden" name="txtItem"
                                                                   value="<?php echo $vRow->getSir52()->getItem(); ?>">
                                                            <div class="panel">
                                                                <a class="panel-heading" role="tab" id="headingOne"
                                                                   data-toggle="collapse" data-parent="#accordion"
                                                                   href="#<?php echo $vRow->getSir52()->getItem(); ?>"
                                                                   aria-expanded="true" aria-controls="collapseOne">
                                                                    <h4 class="panel-title">Número de
                                                                        Item <?php echo $vRow->getSir52()->getItem(); ?></h4>
                                                                </a>
                                                                <div id="<?php echo $vRow->getSir52()->getItem(); ?>"
                                                        ...
                                                        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#m<?php echo $nCont;?>">Cargas Fotos</button>

                                                        <div class="modal fade bs-example-modal-2g" id="m<?php echo $nCont;?>" tabindex="-1" role="dialog" aria-hidden="true">
                                                ...
                                                ?>
                                                <h2>No se encontraron ITEMS para esta factura</h2>
                                            <?php
                                            }
