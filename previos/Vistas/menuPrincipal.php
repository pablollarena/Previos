...
$nick = "";
    if(isset($_SESSION['sUser']) && !empty($_SESSION['sUser'])){
        ...
        if($oPers->getReferen() == 1){
            ...
            $sErr = "El usuario y/o contraseña son incorrectos";
        }
...
<div class="container body">
    <div class="main_container">
        <div class="col-md-3 left_col">
            <div class="left_col scroll-view">
                <div class="navbar nav_title" style="border: 0;">
                    <img src="../images/belchez.png" class="img-responsive" />
                </div>
        ...
        <div class="right_col" role="main">
           <div>
               <img src="../images/trimex.png" class="img-responsive" alt="">
           </div>
        </div>
        <!-- /page content -->
        ...
        <footer>
            <div class="pull-right">
                <a href="http://www.grupobelchez.com/">Trimodal de México S.C</a>
            </div>
            <div class="clearfix"></div>
        </footer>
        <!-- /footer content -->
