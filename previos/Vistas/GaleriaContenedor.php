...
include_once ("../Modelos/ImagenesContenedor.php");
session_start();
$oMenu = new Menu();
$oPers = new Persona();
...
if(isset($_SESSION['sUser']) && !empty($_SESSION['sUser'])){
    ...
    $oImg->setSir76(new Sir76Contenedores());
    $oImg->getSir60()->setReferencia($sRef1);
    $oImg->getSir76()->setNumero($nCont);
    $arrImg = $oImg->buscarImagenesContenedor();
