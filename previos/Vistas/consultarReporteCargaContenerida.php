...
if(isset($_SESSION['sUser']) && !empty($_SESSION['sUser'])){
    ...
    $arrRef = $oRep->buscarReferenciaCargaContenerizada();
            ...
            <div class="">
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        ...
                        <form id="frmPrevios" action="../Controladores/reporteCargaContenerizada.php" method="post">
                            <input type="hidden" name="txtRef" />
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="x_panel">
                                    <div class="x_title">
                                        <h2>LISTA DE REFERENCIAS<small></small></h2>
                                        <div class="clearfix"></div>
                                    </div>
                                    <div class="x_content">
