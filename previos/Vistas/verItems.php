                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    <div class="form-group">
                                                                                        ...
                                                                                        <div class="col-md-6 col-sm-9 col-xs-12">
                                                                                            <input type="text" class="form-control" name="txtCantidad" id="txtCantidad" value="<?php echo $vRow->getCant(); ?>" disabled >
                                                                                        </div>
                                                                                    </div>
                                                                                </td>
                                                                                <td>
                                                                                    ...
                                                                                    <div class="col-md-6 col-sm-9 col-xs-12">
                                                                                        ...
                                                                                        if ($vRow->getCompleta() == 1){
                                                                                            ?>
                                                                                            <input type="text" class="form-control" name="txtCompleta" id="txtCompleta" value="Completa" disabled>
                                                                                        <?php
                                                                                        }else if($vRow->getFaltante() == 1){
                                                                                            ?>
                                                                                            <input type="text" class="form-control" name="txtFaltante" id="txtFaltante" value="Faltante" disabled>
                                                                                        <?php
                                                                                        }else if($vRow->getSobrante() == 1){
                                                                                            ?>
                                                                                            <input type="text" class="form-control" name="txtSobrante" id="txtSobrante" value="Sobrante" disabled >
                                                                                        <?php
                                                                                        }
                                                                                        ?>
                                                                            ...
                                                                            <tr>
                                                                                <td>
                                                                                    <div class="form-group">
                                                                                        ...
                                                                                        <div class="col-md-6 col-sm-9 col-xs-12">
                                                                                          ...
                                                                                          if($vRow->getPieza() == 1 ){
                                                                                              ?>
                                                                                              <input type="text" class="form-control" name="txtPieza" id="txtPieza" value="Pieza" disabled>
                                                                                            <?php

                                                                                          }else if ($vRow->getJuego() == 1){
                                                                                              ?>
                                                                                              <input type="text" class="form-control" name="txtJuego" id="txtJuego" value="Juego" disabled>
                                                                                            <?php
                                                                                          } else if ($vRow->getOtro() == 1){
                                                                                              ?>
                                                                                              <input type="text" class="form-control" name="txtOtro" id="txtOtro" value="Otro" disabled>
                                                                                            <?php
                                                                                          }
                                                                                          ?>
                                                                                        </div>
                                                                                ...
                                                                                <td>
                                                                                    <div class="form-group">
                                                                                        ...
                                                                                        <div class="col-md-6 col-sm-9 col-xs-12">
                                                                                            <input type="text" class="form-control" name="txtOrigen" id="txtOrigen" value="<?php echo $vRow->getOrigen(); ?>" disabled>
                                                                                        </div>
                                                                                    </div>
                                                                                </td>
                                                                                <td>
                                                                                    <div class="form-group">
                                                                                        ...
                                                                                        <div class="col-md-6 col-sm-9 col-xs-12">
                                                                                            <input type="text" class="form-control" name="txtPesoAprox" id="txtPesoAprox" value="<?php echo $vRow->getPesoAprox();?>" disabled>
                                                                                        </div>
                                                                                    </div>
                                                                                </td>
                                                                            </tr>
